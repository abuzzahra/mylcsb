...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const DashboardWidget() : const Login3Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'Outstation',
          path: '/outstation',
          builder: (context, params) => OutstationWidget(
            staffID: params.getParam('staffID', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'OSView',
          path: '/oSView',
          builder: (context, params) => const OSViewWidget(),
        ),
        FFRoute(
          name: 'Notification',
          path: '/notification',
        ...
        FFRoute(
          name: 'ClaimListByYear',
          path: '/claimListByYear',
          builder: (context, params) => const ClaimListByYearWidget(),
        ),
        FFRoute(
          name: 'LeaveDetail',
          path: '/leaveDetail',
          builder: (context, params) => LeaveDetailWidget(
        ...
        FFRoute(
          ...
          builder: (context, params) => const Home05TravelAppWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => FormWidget(
            fillIn: params.getParam('fillIn', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'Info',
        ...
        FFRoute(
          name: 'FormOut',
          path: '/formOut',
          builder: (context, params) => const FormOutWidget(),
        ),
        FFRoute(
          name: 'InfoOut',
          path: '/infoOut',
          builder: (context, params) => const InfoOutWidget(),
        ),
        FFRoute(
          name: 'Scan',
          path: '/scan',
