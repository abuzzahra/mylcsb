...
import 'o_s_view_model.dart';
export 'o_s_view_model.dart';

class OSViewWidget extends StatefulWidget {
  const OSViewWidget({super.key});

  @override
  _OSViewWidgetState createState() => _OSViewWidgetState();
}

class _OSViewWidgetState extends State<OSViewWidget>
    with TickerProviderStateMixin {
  late OSViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OSViewModel());
