...
import 'outstation_model.dart';
export 'outstation_model.dart';

class OutstationWidget extends StatefulWidget {
  const OutstationWidget({
    super.key,
  ...
  @override
  _OutstationWidgetState createState() => _OutstationWidgetState();
}

class _OutstationWidgetState extends State<OutstationWidget> {
  late OutstationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OutstationModel());
  }
