...
export 'claim_detail_model.dart';

class ClaimDetailWidget extends StatefulWidget {
  const ClaimDetailWidget({
    super.key,
    String? id,
  })  : id = id ?? 'claimId';
  ...
  @override
  _ClaimDetailWidgetState createState() => _ClaimDetailWidgetState();
}

class _ClaimDetailWidgetState extends State<ClaimDetailWidget> {
  late ClaimDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClaimDetailModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: ClaimByClaimIdCall.call(
        id: widget.id,
      ),
      builder: (context, snapshot) {
        ...
        final claimDetailClaimByClaimIdResponse = snapshot.data!;
                            ...
                            children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              valueOrDefault<String>(
                                                ClaimStruct.maybeFromMap(
                                                        claimDetailClaimByClaimIdResponse
                                                            .jsonBody)
                                                    ?.year,
                                                'year',
                                              ),
                              ...
                              FutureBuilder<ApiCallResponse>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final listViewClaimByClaimDetailResponse =
                                      snapshot.data!;
                                  return Builder(
                                    builder: (context) {
                                      final claimDetail =
                                          (listViewClaimByClaimDetailResponse
                                                          .jsonBody
                                                          .toList()
                                                          .map<ClaimStruct?>(
                                                              ClaimStruct
                                      ...
                                      return RefreshIndicator(
                                        ...
                                        child: ListView.builder(
                                          ...
                                          shrinkWrap: true,
                                          scrollDirection: Axis.vertical,
                                          itemCount: claimDetail.length,
                                          itemBuilder:
                                              (context, claimDetailIndex) {
                                            final claimDetailItem =
                                                claimDetail[claimDetailIndex];
                                            return Visibility(
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Text(
                                                                          valueOrDefault<
                                                                              String>(
                                                                            claimDetailItem.totalRate.toString(),
                                                                            'totalRate',
                                                                          ),
                                                                          style:
                                                                              FlutterFlowTheme.of(context).bodyMedium,
